...
def get_translations():
    ...
    return {
        ...
        "Hindi": {
            ...
            "total_stories": "साझा की गई कहानियां",
            "total_words": "शक्ति के शब्द",
            "community_support": "सामुदायिक आवाज़ें",
            "filter_all": "सभी कहानियां",
            "filter_recent": "हाल की",
            "filter_popular": "सबसे समर्थित",
            "search_placeholder": "कहानियां खोजें...",
        ...
        "Tamil": {
            ...
            "error": "காலியான கதையை சமர்ப்பிக்க வேண்டாம்.",
            "transcribed": "குரலிலிருந்த உரை (நீங்கள் திருத்தலாம்):",
            ...
            "footer_title": "சக்தி - குரல்களை வலுப்படுத்தல், சமூகத்தை கட்டமைத்தல்",
            "footer_community": "பகிரப்பட்ட ஒவ்வொரு கதையும் நமது சமூகத்தை வலுவாக்குகிறது",
            "footer_dedication": "உயிர் பிழைத்தவர்கள் மற்றும் ஆதரவாளர்களுக்காக ❤️ உடன் உருவாக்கப்பட்டது"
        },
        "Bengali": {
            "title": "শক্তি",
            "subtitle": "প্রতিটি কণ্ঠস্বর শোনার যোগ্য",
            "tagline": "আপনার গল্প শেয়ার করুন, অন্যদের অনুপ্রাণিত করুন",
            "upload_audio": "🎙️ আপনার কণ্ঠস্বর শেয়ার করুন",
            "write_story": "✏️ আপনার গল্প লিখুন",
            "submit": "গল্প শেয়ার করুন",
            "success": "আপনার গল্প সফলভাবে শেয়ার হয়েছে!",
            "error": "অনুগ্রহ করে খালি গল্প জমা দেবেন না।",
            "transcribed": "কণ্ঠস্বর থেকে লেখা (আপনি সম্পাদনা করতে পারেন):",
            ...
            "footer_community": "ভাগাভাগি করা প্রতিটি গল্প আমাদের সম্প্রদায়কে আরো শক্তিশালী করে তোলে",
